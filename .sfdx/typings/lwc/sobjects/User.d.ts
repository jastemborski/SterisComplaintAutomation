...
declare module "@salesforce/schema/User.CMPL123__ESign_Hint_Answer_1__c" {
  const CMPL123__ESign_Hint_Answer_1__c:string;
  export default CMPL123__ESign_Hint_Answer_1__c;
}
declare module "@salesforce/schema/User.CMPL123__ESign_Hint_Answer_2__c" {
  const CMPL123__ESign_Hint_Answer_2__c:string;
  export default CMPL123__ESign_Hint_Answer_2__c;
}
declare module "@salesforce/schema/User.CMPL123__ESign_Hint_Question_1__c" {
  const CMPL123__ESign_Hint_Question_1__c:string;
  export default CMPL123__ESign_Hint_Question_1__c;
}
declare module "@salesforce/schema/User.CMPL123__ESign_Hint_Question_2__c" {
  const CMPL123__ESign_Hint_Question_2__c:string;
  export default CMPL123__ESign_Hint_Question_2__c;
}
declare module "@salesforce/schema/User.CMPL123__ESign_Password_Expired_Date__c" {
  const CMPL123__ESign_Password_Expired_Date__c:any;
  export default CMPL123__ESign_Password_Expired_Date__c;
}
declare module "@salesforce/schema/User.CMPL123__ESign_Password__c" {
  const CMPL123__ESign_Password__c:string;
  export default CMPL123__ESign_Password__c;
}
declare module "@salesforce/schema/User.CMPL123__Occasional_User__c" {
  const CMPL123__Occasional_User__c:boolean;
  export default CMPL123__Occasional_User__c;
}
declare module "@salesforce/schema/User.CMPL123__Original_Name__c" {
  const CMPL123__Original_Name__c:string;
  export default CMPL123__Original_Name__c;
}
declare module "@salesforce/schema/User.Facility__c" {
  const Facility__c:string;
  export default Facility__c;
}
declare module "@salesforce/schema/User.Is_Business_Admin__c" {
  const Is_Business_Admin__c:boolean;
  export default Is_Business_Admin__c;
}
declare module "@salesforce/schema/User.Is_Complaint_Coordinator__c" {
  const Is_Complaint_Coordinator__c:boolean;
  export default Is_Complaint_Coordinator__c;
}
declare module "@salesforce/schema/User.Is_Engineering__c" {
  const Is_Engineering__c:boolean;
  export default Is_Engineering__c;
}
declare module "@salesforce/schema/User.Is_Manufacturing__c" {
  const Is_Manufacturing__c:boolean;
  export default Is_Manufacturing__c;
}
declare module "@salesforce/schema/User.Is_NCR_Assignee__c" {
  const Is_NCR_Assignee__c:boolean;
  export default Is_NCR_Assignee__c;
}
declare module "@salesforce/schema/User.Is_Operations__c" {
  const Is_Operations__c:boolean;
  export default Is_Operations__c;
}
declare module "@salesforce/schema/User.Is_Quality_Manager__c" {
  const Is_Quality_Manager__c:boolean;
  export default Is_Quality_Manager__c;
}
declare module "@salesforce/schema/User.Is_Regulatory__c" {
  const Is_Regulatory__c:boolean;
  export default Is_Regulatory__c;
}
declare module "@salesforce/schema/User.Person_ID__c" {
  const Person_ID__c:string;
  export default Person_ID__c;
}
declare module "@salesforce/schema/User.Coordinator_Type__c" {
  const Coordinator_Type__c:string;
  export default Coordinator_Type__c;
}
